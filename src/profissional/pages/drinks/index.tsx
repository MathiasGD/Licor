...
function Drinks() {
  ...
  >([{ ingredienteId: "", unidadeMedida: "", quantidade: "" }]);
  ...
  const atualizarIngrediente = (
    index: number,
    campo: "ingredienteId" | "quantidade" | "unidadeMedida",
    valor: number | string
  ) => {
        ...
        <div className="flex flex-col justify-between gap-3 min-h-full">
          <div className="flex flex-col gap-3">
            ...
            <TextField
              ...
              placeholder="Nome"
              value={nomeNovoDrink}
              onChange={(e) => setNomeNovoDrink(e.target.value)}
            />
            ...
            <TextField
              ...
              placeholder="Preço"
              type="number"
              value={precoNovoDrink}
              onChange={(e) => setPrecoNovoDrink(e.target.value)}
            />
            <div className="w-full h-px bg-branco-muito-escuro" />
            <TextField
              fullWidth
              placeholder="Descrição"
              value={descricaoNovoDrink}
              onChange={(e) => setDescricaoNovoDrink(e.target.value)}
            />
            <div className="w-full h-px bg-branco-muito-escuro" />
            ...
            <TextField
              ...
              value={modoPreparoNovoDrink}
              onChange={(e) => setModoPreparoNovoDrink(e.target.value)}
            />
          </div>
          <div className="flex flex-col gap-2 w-full">
            ...
            <Button
              ...
              disableElevation
              onClick={() => {
                cadastrarDrink.mutateAsync({
                  nome: nomeNovoDrink,
                  modoPreparo: modoPreparoNovoDrink,
                  precoBase: Number(precoNovoDrink),
                  descricao: descricaoNovoDrink,
