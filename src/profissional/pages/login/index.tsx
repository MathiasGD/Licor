...
import { TipoUsuario, useCadastrarUsuario, useLogin } from "../../../services/geral";
...
const Login = () => {
  ...
  const [tipoUsuario, setTipoUsuario] = useState<TipoUsuario>(TipoUsuario.PROFISSIONAL);
      ...
      <Modal isOpen={openModalCadastro}>
        <div className="flex flex-col justify-between gap-3 min-h-full">
          <div className="flex flex-col gap-3">
            <p className="text-xl font-medium text-roxo-escuro self-center">Cadastrar Usuário</p>
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            >
              {cadastrarUsuarioMutation.isPending ? "Cadastrando..." : "Cadastrar"}
            </Button>
          </div>
        </div>
      </Modal>    
